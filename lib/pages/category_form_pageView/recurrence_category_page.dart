  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          Text(
            'Essa categoria será mensal ou única?',
              ...
              return Column(
                children: [
                  AnimatedToggleSwitch<bool>.dual(
                    ...
                    borderWidth: 5.0,
                    height: 55,
                    onChanged: (value) => GetIt.I<CategoryFormCubit>()
                    ...
                    child: Padding(
                      ...
                      child: state.recurrenceMode == RecurrenceMode.monthly
                          ? Column(
                              ...
                              children: [
                                Text(
                                  'Categorias mensais são aquelas que você provavelmente terá até o fim do ano.',
                                  style: AppTheme.textStyles.subTileTextStyle
                                      .copyWith(
                                ...
                                Text(
                                  'Não se preocupe, se precisar você pode desativar a categoria a qualquer momento e ela não aparecerá mais para os meses seguintes.',
                                  style: AppTheme.textStyles.subTileTextStyle
                                      .copyWith(
                                          color: AppTheme.colors.hintTextColor
                                              .withAlpha(100)),
                          ...
                          : Column(
                            ...
                            children: [
                              Text(
                                  'Categorias únicas servirão apenas para o mês em questão.',
                                  style: AppTheme.textStyles.subTileTextStyle
                                      .copyWith(
                                          color: AppTheme.colors.hintTextColor
                                              .withAlpha(100)),
